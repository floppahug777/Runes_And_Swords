...
public class GameActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        redButton.setBackgroundResource(R.drawable.pixil_frame_0__2__photoroom);
        greenButton.setBackgroundResource(R.drawable.pixil_frame_0__1__photoroom);
        yellowButton.setBackgroundResource(R.drawable.pixil_frame_0__3__photoroom);
        blueButton.setBackgroundResource(R.drawable.pixil_frame_0_photoroom);
    ...
    public void onClick(View v) {
        ...
        if (clickedButton == yellowButton){
            yellowButton.setBackgroundResource(R.drawable.pixil_frame_0__2__photoroom__1_);
            ...
            redButton.setBackgroundResource(R.drawable.pixil_frame_0__2_3_photoroom);
            ...
            blueButton.setBackgroundResource(R.drawable.pixil_frame_0__2_2_photoroom);
            ...
            greenButton.setBackgroundResource(R.drawable.pixil_frame_0__2_1_photoroom);
    ...
    private void newRound() {
        int[] spriteIds = {
                R.drawable.titansword
                //R.drawable.axe,
                //R.drawable.dagger
        };
        int randomIndex = random.nextInt(spriteIds.length);
        weaponName = String.valueOf(spriteIds[randomIndex]);

        weaponView.setImageResource(spriteIds[randomIndex]);
...
//        String niceWeapon = weaponName + "nice";
//        int resourceId = getResources().getIdentifier(niceWeapon, "drawable", getPackageName());
//        weaponView.setImageResource(resourceId);
//        Log.e("MainActivity", niceWeapon);
        weaponView.setImageResource(R.drawable.titanswordnice);
...
//        String niceWeapon = weaponName + "broken";
//        int resourceId = getResources().getIdentifier(niceWeapon, "drawable", getPackageName());
//        weaponView.setImageResource(resourceId);
        weaponView.setImageResource(R.drawable.titanswordbroken);
